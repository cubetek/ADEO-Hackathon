...
const conversations = ref<Conversation[]>([
  {
    ...
    messages: [{
      type: "received",
      text: "هذا ملخص للوثيقة: **ملخص التنفيذي** * مقترح إضافة بوابة تعرفة مرورية على شارع الكورنيش في أبوظبى. * الوثيقة سرية للاشخاص المعنيين. **تفاصيل** * تركيب 5 بوابات جديدة على الشارع الكورنيش. * تطبيق تعرفة بقيمة 2 درهم لكل بوابة. * التكلفة الرأسمالية الإضافية: 10 مليون درهم إجمالي و 2 مليون لكل بوابة. * وقت تفعيل البوابات في وقت الذروة (7-9 صباحاً و5-7 مساءً). **التحليل المالى** * لم يتم تقديم تفاصيل مالية. **الوقف المالى للجهة** * لم يتم تقديم تفاصيل مالية.",
      time: "10:00 AM",
      attachments: [],
    }],
  },
